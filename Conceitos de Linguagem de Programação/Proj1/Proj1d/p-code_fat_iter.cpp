...
int main(){
  ...
  code[2].f = LIT; code[2].l = 0; code[2].a = 1;
  code[3].f = STO; code[3].l = 0; code[3].a = 4;
  code[4].f = LOD; code[4].l = 0; code[4].a = 3; // fatorial atual
  code[5].f = LOD; code[5].l = 0; code[5].a = 4; // resultado
  code[6].f = OPR; code[6].l = 0; code[6].a = 4;
  code[7].f = STO; code[7].l = 0; code[7].a = 4;
  code[8].f = LOD; code[8].l = 0; code[8].a = 3;
  code[9].f = LIT; code[9].l = 0; code[9].a = 1;
  code[10].f = OPR; code[10].l = 0; code[10].a = 3;
