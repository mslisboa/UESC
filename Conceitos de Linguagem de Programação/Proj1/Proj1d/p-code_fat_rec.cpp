...
int main(){
  ...
  code[0].f = JMP; code[0].l = 0; code[0].a = 16;

  // fat(4)
  code[1].f = INT; code[1].l = 0; code[1].a = 5;
  code[2].f = LOD; code[2].l = 0; code[2].a = 3;
  code[3].f = LIT; code[3].l = 0; code[3].a = 1;
  code[4].f = OPR; code[4].l = 0; code[4].a = 8; // fatorial atual
  code[5].f = JPC; code[5].l = 0; code[5].a = 23; // resultado
  ...
  // main
  code[16].f = INT; code[16].l = 0; code[16].a = 5;
  code[17].f = LIT; code[17].l = 0; code[17].a = 4;
  code[18].f = STO; code[18].l = 0; code[18].a = 3;
  code[19].f = LOD; code[19].l = 0; code[19].a = 3;
  code[20].f = STO; code[20].l = 0; code[20].a = 8;
  code[21].f = CAL; code[21].l = 0; code[21].a = 1;
  code[22].f = OPR; code[22].l = 0; code[22].a = 0;

  code[23].f = LOD; code[23].l = 0; code[23].a = 3;
  code[24].f = STO; code[24].l = 0; code[24].a = 4;
  code[25].f = JMP; code[25].l = 0; code[25].a = 11;
