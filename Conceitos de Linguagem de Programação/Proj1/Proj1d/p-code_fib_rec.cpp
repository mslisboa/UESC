...
int main(){
  ...
  code[0].f = JMP; code[0].l = 0; code[0].a = 26;

  // fat(4)
  code[1].f = INT; code[1].l = 0; code[1].a = 7;
  code[2].f = LOD; code[2].l = 0; code[2].a = 3;
  code[3].f = LIT; code[3].l = 0; code[3].a = 1;
  code[4].f = OPR; code[4].l = 0; code[4].a = 11;
  code[5].f = JPC; code[5].l = 0; code[5].a = 9;

  code[6].f = LOD; code[6].l = 0; code[6].a = 3;
  code[7].f = STO; code[7].l = 1; code[7].a = 4;
  code[8].f = OPR; code[8].l = 0; code[8].a = 0;

  code[9].f = LOD; code[9].l = 0; code[9].a = 3;
  code[10].f = LIT; code[10].l = 0; code[10].a = 1;
  code[11].f = OPR; code[11].l = 0; code[11].a = 3;
  code[12].f = STO; code[12].l = 0; code[12].a = 10; 
  code[13].f = CAL; code[13].l = 0; code[13].a = 1;
  code[14].f = LOD; code[14].l = 0; code[14].a = 4;
  code[15].f = STO; code[15].l = 0; code[15].a = 5;
  code[16].f = LOD; code[16].l = 0; code[16].a = 3;
  code[17].f = LIT; code[17].l = 0; code[17].a = 2;
  code[18].f = OPR; code[18].l = 0; code[18].a = 3;
  code[19].f = STO; code[19].l = 0; code[19].a = 8;
  code[20].f = CAL; code[20].l = 0; code[20].a = 1;
  code[21].f = LOD; code[21].l = 0; code[21].a = 4;
  code[22].f = LOD; code[22].l = 0; code[22].a = 5;
  code[23].f = OPR; code[23].l = 0; code[23].a = 2;
  code[24].f = STO; code[24].l = 1; code[24].a = 6;
  code[25].f = OPR; code[25].l = 0; code[25].a = 0;

  // main
  code[26].f = INT; code[26].l = 0; code[26].a = 5;
  code[27].f = LIT; code[27].l = 0; code[27].a = 5;
  code[28].f = STO; code[28].l = 0; code[28].a = 3;
  code[29].f = LOD; code[29].l = 0; code[29].a = 3;
  code[30].f = STO; code[30].l = 0; code[30].a = 8;
  code[31].f = CAL; code[31].l = 0; code[31].a = 1;
